'''
Link : 		http://www.geeksforgeeks.org/bitmasking-and-dynamic-programming-set-1-count-ways-to-assign-unique-cap-to-every-person/
Source : 	CodeChef
Algorithm : DP + bitmasking
Complexity : O(K*2^N) where K is number of caps
